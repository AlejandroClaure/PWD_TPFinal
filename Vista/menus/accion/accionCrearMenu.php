...
// Normalizar nombre menú (para título)
$menombre = ucfirst($menombre);

// Crear slug seguro para el archivo
...
// Ruta física final donde se creará el archivo
$carpetaSecciones = dirname(__DIR__, 3) . "/Vista/secciones/";
...
// Calcular cuántos ../ necesita el archivo generado
...
<div class="container mt-4 pt-4">
    <h1 class="mb-4"><?= htmlspecialchars('REPLACEMENOMBRE'); ?></h1>
